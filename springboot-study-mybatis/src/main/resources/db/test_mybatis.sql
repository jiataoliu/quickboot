...
-- 插入测试数据
INSERT INTO `test_mybatis` VALUES(1, '张三', '666666', 1, sysdate(), sysdate(), '');
INSERT INTO `test_mybatis` VALUES(2, '李四', '666666', 1, sysdate(), sysdate(), '');
INSERT INTO `test_mybatis` VALUES(3, '王五', '666666', 1, sysdate(), sysdate(), '');
INSERT INTO `test_mybatis` VALUES(4, '赵六', '666666', 1, sysdate(), sysdate(), '');
INSERT INTO `test_mybatis` VALUES(5, '田七', '666666', 1, sysdate(), sysdate(), '');
