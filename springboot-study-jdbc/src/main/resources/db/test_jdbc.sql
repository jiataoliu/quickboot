...
-- 创建一个表
DROP TABLE IF EXISTS `test_jdbc`;
...
-- 插入测试数据
INSERT INTO `test_jdbc` VALUES(1, '张三', '666666', 1, sysdate(), sysdate(), '');
INSERT INTO `test_jdbc` VALUES(2, '李四', '666666', 1, sysdate(), sysdate(), '');
INSERT INTO `test_jdbc` VALUES(3, '王五', '666666', 1, sysdate(), sysdate(), '');
INSERT INTO `test_jdbc` VALUES(4, '赵六', '666666', 1, sysdate(), sysdate(), '');
INSERT INTO `test_jdbc` VALUES(5, '田七', '666666', 1, sysdate(), sysdate(), '');
